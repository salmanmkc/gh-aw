...
func (c *Compiler) buildHandlerManagerStep(data *WorkflowData) []string {
	...
	// Note: update_project and create_project_status_update are now in the regular handler manager
...
// to dispatch project-related messages (create_project, copy_project) to appropriate handlers.
...
func (c *Compiler) buildProjectHandlerManagerStep(data *WorkflowData) []string {
	...
	// Note: update_project and create_project_status_update have been moved to regular handler manager
